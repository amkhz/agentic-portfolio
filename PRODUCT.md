...
> **The full visual specification lives in `DESIGN.md`** (color, typography, motion, imagery, composition), binding to ADR-013 ("The Conservatory"). This section is the brand-level summary. The brass+magenta "editorial craftsperson" direction (ADR-011) is superseded; the "refuse blandness / design is the credential" intent and three-face spirit are preserved.

**Visual tone:** "The Conservatory" -- an inhabited biophilic-future register. Technology, nature, and people in long-settled, optimistic commune; greenhouse crossed with architecture museum. Wabi-sabi is the load-bearing philosophy (imperfection, patina, honest wear), Danish mid-century craft is present in-scene (Finn Juhl, Hans Wegner), and the posture is subtle luxury and agency, never flashy. The portfolio reads as an authored object, a designer's worldview that happened to ship as a website. The design IS the credential.
...
**Typography:** Warm humanist body sans + refined display + structural mono, three-face spirit. Faces LOCKED v2 (2026-06-24): Hedvig Letters Serif (display, single-weight) / Figtree (body + UI, variable) / JetBrains Mono (kicker), validated live both modes and Justin-approved. This "Stack E" lock deliberately reopened the 2026-06-21 Fraunces/Source Sans 3 lock (Fraunces had begun to read as an AI tell). See DESIGN.md.
...
**References:** Danish mid-century furniture craft (Finn Juhl, Hans Wegner). Biophilic architecture (Jewel Changi, Gardens by the Bay, Eden Project, Apple Park, Kengo Kuma, Foster). Seamless lived-in technology (Blade Runner 2049, The Expanse, Her; William Gibson). Wabi-sabi, the beauty of imperfection and honest wear.
