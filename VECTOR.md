...
4. **Tasteful motion** -- Motion is a pillar of the visual system: restrained but expressive, ease-out exponential, no bounce or elastic. It serves arrival and focus, never spectacle. Most things still; the rare moment earns its weight. Respects `prefers-reduced-motion`. See `DESIGN.md`.
