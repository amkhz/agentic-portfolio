...
A design system isn't a component library. It's a set of decisions that compound. Every token, every constraint, every naming convention makes the next thousand decisions easier or harder. This one was built to make the hard decisions once and let everything else follow.
