...
glossary:
  ...
  dynamic vacuum: "The paper's central concept: the quantum vacuum treated as a literal physical medium with measurable properties (density, elasticity, sound speed) that responds to the matter inside it. A proton doesn't sit in passive empty space; it reshapes the medium around itself, and that reshaped medium decides which waves can live there."
  ...
  speed of sound: "Acoustic disturbances in this vacuum model travel at different speeds depending on position, just as sound moves faster in steel than in air. Near the proton the medium is denser and springier, so the effective sound speed changes, and that variation is what creates the atomic structure."
  ...
  wavenumber: "A measure of spatial frequency: how many wave cycles fit into a given distance. High wavenumber = short wavelength = tightly packed waves. The paper labels it 'q' or 'k'; think of it as the spatial equivalent of frequency."
  ...
  Madelung hydrodynamics: "In 1927, Erwin Madelung showed you can rewrite the Schrödinger equation as two fluid dynamics equations plus an extra term called the quantum potential. It's mathematically identical to QM, just a different language. White uses this to motivate treating the vacuum as an actual fluid."
  reduced Planck constant: "Written as ℏ (\"h-bar\"), it's Planck's constant h divided by 2π. It's the fundamental quantum of action, setting the scale at which quantum effects become important. Its value is incredibly tiny: ~1.055 × 10⁻³⁴ J·s."
  reduced mass: "When two bodies orbit each other (like an electron and proton), you can simplify the math by replacing them with one body of \"reduced mass\" μ = (m₁·m₂)/(m₁+m₂). For hydrogen, μ ≈ 0.99946 × mₑ, which is almost the electron mass since the proton is ~1836 times heavier."
  ...
  1/r term: "A quantity that gets larger as you get closer to the proton (as r shrinks). This is the same mathematical form as the Coulomb electric potential (V = ke²/r) and gravitational potential. It's what makes hydrogen hydrogen: the signature of a single point charge."
  ...
  evanescent: "A wave that decays exponentially instead of propagating. Think of the \"ghost\" wave that penetrates a tiny distance past a totally reflecting surface before dying off. In this model, bound states are evanescent in the far field (A < 0), which is what traps them near the proton."
  ...
  Rydberg formula: "The empirical formula discovered by Johannes Rydberg in 1888 that predicts all hydrogen spectral lines: 1/λ = R(1/n₁² − 1/n₂²). Why this simple pattern exists was one of the great mysteries of 19th-century physics. Standard QM explains it through the Schrödinger equation; this paper explains it through acoustic resonance."
  ...
  pilot-wave: "Also called de Broglie-Bohm theory: a deterministic interpretation of QM where particles are real objects with definite positions at all times, guided by a \"pilot wave\" that obeys the Schrödinger equation. This paper's acoustic framework has strong conceptual parallels, with the vacuum medium playing a role similar to the pilot wave."
  ...
  quantum potential: "The term Q = −(ℏ²/2μ)·∇²√ρ/√ρ that appears in the Madelung picture. It's bizarre because it depends on the curvature of the density field: a fluid element \"knows\" about the shape of the density around it, not just the local value. That nonlocal character is what produces quantum behavior in the hydrodynamic picture, and in the paper it generates the k⁴ (dispersive) correction to normal sound propagation."
  ...
  Bogoliubov dispersion: "The dispersion relation for excitations in a superfluid or BEC: ω² = c²k² + (ℏ²/4m²)k⁴. At low k, excitations are sound-like (phonons); at high k, they become particle-like with quadratic dispersion. This dual character is a key feature of quantum fluids, and the paper works in the high-k limit."
...
In everyday language, "vacuum" means empty space. But in modern physics, the vacuum is anything but empty. It has energy, it has fluctuations, and it can exert forces (like the |Casimir effect|). This paper takes that idea further and treats the vacuum as a literal physical medium, something like air or water, with measurable properties like |density| and |elasticity|.

> **Casimir effect**: A real, measured force between two very close metal plates caused by vacuum fluctuations. It proves the vacuum has physical properties. White's company is literally named "Casimir, Inc."; this is central to his research program.

The word "dynamic" is key: a |dynamic vacuum| responds to what's in it. A proton doesn't just sit passively in empty space. It |imprints| a structure onto the vacuum, creating a radially varying medium where the |speed of sound| changes depending on how far you are from the proton.
...
But this vacuum model has |quadratic dispersion|: ω = Dq². If you double the wavenumber, the frequency *quadruples*. This specific relationship isn't arbitrary. It's the same mathematical form as the kinetic energy term in the |Schrödinger equation| (E = ℏ²k²/2m). The paper derives this from |Madelung hydrodynamics|, which is a way of rewriting quantum mechanics as fluid dynamics.
...
> **Design Hook**
>
> **The vacuum as a workable material:** If vacuum properties are tunable the way density and elasticity are tunable in any other medium, vacuum engineering eventually needs what every materials practice has: spec sheets, profile catalogs, instruments that show you what you just changed. Picture a bench tool where you dial in a constitutive profile and watch which resonances survive, the way an audio engineer shapes a room and listens to what it does to the signal. The design challenge: make an invisible medium feel as workable as wood or steel.
