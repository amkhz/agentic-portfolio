...
- **Selecta** (the Selector, named 2026-07-06) DJ set-builder -- PLANNED end to end: ADR-020, `plans/selecta.md`, mission manifest `vector/missions/selecta-mission-1.md` (8 tasks, all landing in lastfm-mcp). Vinyl surfacing fast-follows Discogs sync (lastfm-mcp issue #13).
