...
/**
 * Animated thread lines background -- WebGL shader.
...
interface ThreadsProps {
  /** Thread color as [r, g, b] normalized (0-1). Defaults to brass. */
...
export function Threads({
  ...
  }, [color, amplitude, distance, enableMouseInteraction, prefersReduced]);
