    ...
    <div className={cn("border-t border-border-subtle", className)}>
      <div className="mx-auto max-w-5xl px-6">
        ...
        <a
          ...
          className="flex w-fit items-center gap-3 rounded-md px-2 py-1 transition-colors duration-200 hover:bg-bg-elevated focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary focus-visible:ring-offset-2 focus-visible:ring-offset-bg-deep"
          aria-label={`${statusLabel}: ${track.name} by ${track.artist}. View Last.fm profile.`}
        >
          ...
          {track.albumArt ? (
            <img
              ...
              className={cn(
                "rounded",
                isPlaying && "shadow-[0_0_10px_var(--theme-accent-glow)]"
              )}
            />
          ) : (
