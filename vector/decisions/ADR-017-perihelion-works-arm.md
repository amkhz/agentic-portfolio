...
**Date:** 2026-07-03 (decision shaped 2026-07-02, per `plans/works-01-the-flight-deck.md`; ratified 2026-07-03)
**Status:** accepted
**Deciders:** Justin Hernandez (direction); drafted by Tyrell via invest-adr

> **Ratification record (2026-07-03):** shape brief (`vector/briefs/works-01-flight-deck-shape-2026-07-03.md`) confirmed by Justin. Of the two clauses shape was permitted to amend, D4 gained the one-line commit-moment choreography and D6's budget numbers stand as drafted. The name is confirmed: **The Flight Deck**. Also resolved at confirmation: audio ships as alert grammar only (spatial soundscape parks as fast-follow); Wallace probes are sanctioned for Works (D3). Roy reviews the build against this document as ratified.
